...
if not os.path.exists(ruta_json):
    ...
    promedio = notas[["Matemáticas", "Lenguaje", "Ciencias", "Historia", 
"Inglés"]].mean()
    asignaturas = ["Matemáticas", "Lenguaje", "Ciencias", "Historia", 
"Inglés"]
...
<table border="1" cellpadding="6" style="border-collapse: 
collapse;">
